  ...
  return (
    <div>
      <h2 id="blog-post-heading" data-cy="BlogPostHeading">
        <Translate contentKey="alpscraftCmsApp.blogPost.home.title">Blog Posts</Translate>
        ...
        {blogPostList && blogPostList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="alpscraftCmsApp.blogPost.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="alpscraftCmsApp.blogPost.author">Author</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="alpscraftCmsApp.blogPost.home.notFound">No Blog Posts found</Translate>
            </div>
          )
        )}
      </div>
