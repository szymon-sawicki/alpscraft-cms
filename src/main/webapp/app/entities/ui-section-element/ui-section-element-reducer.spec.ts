...
import reducer, {
  ...
  reset,
  updateEntity,
} from './ui-section-element.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UISECTIONELEMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UISECTIONELEMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UISECTIONELEMENT actions', async () => {
      const arg = { id: 15812 };
    ...
    it('dispatches UPDATE_UISECTIONELEMENT actions', async () => {
      const arg = { id: 15812 };
    ...
    it('dispatches PARTIAL_UPDATE_UISECTIONELEMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UISECTIONELEMENT actions', async () => {
      const arg = 42666;
