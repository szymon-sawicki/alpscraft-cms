...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UISECTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UISECTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UISECTION actions', async () => {
      const arg = { id: 10324 };
    ...
    it('dispatches UPDATE_UISECTION actions', async () => {
      const arg = { id: 10324 };
    ...
    it('dispatches PARTIAL_UPDATE_UISECTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UISECTION actions', async () => {
      const arg = 42666;
